...
namespace RPG.Core
{
    ...
    public class VeryEasyClass : PlayerQuest
    {
        ...
        public override void UpdateQuest(Player _player, int _difficulty, NPC _enemy, int _healingDone, int _damageDone, double _charPercent, List<EnumCharClass> _class, bool battleWasWon)
        {
            ...
            if (_difficulty == -4 && classList.Intersect(_class).Count() != 0 && battleWasWon)
            {
                this.currentValue++;
                if (currentValue == finalValue)
                    this.EndQuest(_player);
    ...
    public class NormalClass : PlayerQuest
    {
        ...
        public override void UpdateQuest(Player _player, int _difficulty, NPC _enemy, int _healingDone, int _damageDone, double _charPercent, List<EnumCharClass> _class, bool battleWasWon)
        {
            ...
            if (_difficulty == 0 && classList.Intersect(_class).Count() != 0 && battleWasWon)
            {
                this.currentValue++;
                if (currentValue == finalValue)
                    this.EndQuest(_player);
    ...
    public class VeryEasyPercentRemaining : PlayerQuest
    {
        ...
        public override void UpdateQuest(Player _player, int _difficulty, NPC _enemy, int _healingDone, int _damageDone, double _charPercent, List<EnumCharClass> _class, bool battleWasWon)
        {
            if (_difficulty == -4 && (_charPercent < 0.35) && battleWasWon)
            {
                this.currentValue++;
                if (currentValue == finalValue)
                    this.EndQuest(_player);
    ...
    public class EasyPercentRemaining : PlayerQuest
    {
        ...
        public override void UpdateQuest(Player _player, int _difficulty, NPC _enemy, int _healingDone, int _damageDone, double _charPercent, List<EnumCharClass> _class, bool battleWasWon)
        {
            if (_difficulty == -2 && (_charPercent < 0.30) && battleWasWon)
            {
                this.currentValue++;
                if (currentValue == finalValue)
                    this.EndQuest(_player);
    ...
    public class NormalPercentRemaining : PlayerQuest
    {
        ...
        public override void UpdateQuest(Player _player, int _difficulty, NPC _enemy, int _healingDone, int _damageDone, double _charPercent, List<EnumCharClass> _class, bool battleWasWon)
        {
            if (_difficulty == 0 && (_charPercent < 0.25) && battleWasWon)
            {
                this.currentValue++;
                if (currentValue == finalValue)
                    this.EndQuest(_player);
    ...
    public class HardPercentRemaining : PlayerQuest
    {
        ...
        public override void UpdateQuest(Player _player, int _difficulty, NPC _enemy, int _healingDone, int _damageDone, double _charPercent, List<EnumCharClass> _class, bool battleWasWon)
        {
            if (_difficulty == 2 && (_charPercent < 0.20) && battleWasWon)
            {
                this.currentValue++;
                if (currentValue == finalValue)
                    this.EndQuest(_player);
    ...
    public class VeryHardPercentRemaining : PlayerQuest
    {
        ...
        public override void UpdateQuest(Player _player, int _difficulty, NPC _enemy, int _healingDone, int _damageDone, double _charPercent, List<EnumCharClass> _class, bool battleWasWon)
        {
            if (_difficulty == 4 && (_charPercent < 0.15) && battleWasWon)
            {
                this.currentValue++;
                if (currentValue == finalValue)
                    this.EndQuest(_player);
    ...
    public class EasyNPCType : PlayerQuest
    {
        ...
        public override void UpdateQuest(Player _player, int _difficulty, NPC _enemy, int _healingDone, int _damageDone, double _charPercent, List<EnumCharClass> _class, bool battleWasWon)
        {
            ...
            if (_difficulty == -2 && monsterType == _enemy.TypeOfNPC && battleWasWon)
            {
                this.currentValue++;
                if (currentValue == finalValue)
                    this.EndQuest(_player);
